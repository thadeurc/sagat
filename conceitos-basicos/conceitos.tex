...
\section{Concorrência em Software}		
	...
	\subsection{MOMs e AMQP}
		...
		\subsection{Akka Dispatchers}
			...
			\subsubsection{Event-based dispatchers}
			...
			Dispatchers baseados em eventos devem, obrigatoriamente, ser compartilhados entre muitos atores, sendo
			uma boa prática deixar cada ator top-level (os supervisores) com seu próprio dispatcher, porém
			utilizar o mesmo dispatcher para cada ator criado pelo supervisor.
