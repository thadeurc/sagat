...
import akka.actor. {Index, LocalActorRef, Actor, RemoteActorRef, TypedActor, ActorRef, IllegalActorStateException, RemoteActorSystemMessage, uuidFrom, Uuid, Exit, LifeCycleMessage, ActorType => AkkaActorType}
...
class ActiveRemoteClientHandler(
  ...
  var removed = new ConcurrentHashMap[Uuid, CompletableFuture[_]]
