...
\frametitle{Objetivos}
	Este trabalho teve como objetivo cruar uma implementa\c{c}\~ao do modelo de atores em Scala que utilize o padr\~ao AMQP
...
\frame{\frametitle{Atores locais}
...
\frame{\frametitle{Trading System}
	explicar trading system
}
\subsection{Compara\c{c}\~ao de desempenho}
\frame{\frametitle{Compara\c{c}\~ao de desempenho}
	graficos
}
