...
%% definir conceitualmente o que eh servidor e cliente
...
transacional ocorre como parte de uma transação atômica que pode incluir também outras
...
O protocolo AMQP (\english{Advanced Message Queuing Protocol}) é uma proposta recente 
