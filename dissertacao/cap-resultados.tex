...
menos de $1$ segundo para completar todos os envios/respostas na instância com $80$ atores clientes. 
De um modo geral, se observarmos a diferença do tempo de execução para os experimentos a partir de 
$8$ atores clientes, onde o sistema começa a atingir seu
...
doo processamento. Na implementação feita com Netty, tanto as classes responsáveis pelo envio e 
...
atores clientes mostrados na tabela \ref{tab:medidas}, com os valores de envios/respostas obtidos para instâncias com $10$
...
$1$ até $2$ clientes do gráfico da figura \ref{fig:grafico-er}, como mostra o gráfico da figura
\ref{fig:grafico-er-lento-e-normal}.
