...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Uso do Protocolo AMQP para o Transporte de Mensagens entre Atores Remotos}}\\
...
%    financeiro da CAPES/CNPq/FAPESP}
    ...
    \vskip 0.5cm
    \normalsize{São Paulo, novembro de 2011}
\end{center}
...
\thispagestyle{empty}
    \begin{center}
        \vspace*{2.3 cm}
        \textbf{\Large{Uso do Protocolo AMQ para o Transporte de Mensagens entre Atores Remotos}}\\
        \vspace*{2 cm}
    \end{center}
...
\begin{tabular}{ll}
         AMQP         & Protocolo Avançado para Enfileramento de Mensagens (\emph{Advanced Message Queuing Protocol})\\
         API          & Interface para Programação de Aplicativos (\emph{Application Programming Interface})\\         
         JMS          & Serviço de Mensagem Java (\emph{Java Message Service})\\
