...
para interligar instâncias distrubuídas de um mesmo sistema (Drizzle ou Akka).
...
A camada de comunição deste arcabouço é análoga à implementação da camada de transporte do Akka.
