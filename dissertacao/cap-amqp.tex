...
\section{Implementações}	
	...
	da existênca de um objeto antes da criação efetiva do objeto. Por exemplo, criamos 
	uma fila durável $F_1$. Caso tentássemos criar uma nova fila durável $F_1$, a fila não seria
	...
	via alguma aplicação administrativa do RabbitMQ.
