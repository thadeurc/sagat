...
\begin{itemize}
	...
	\english{Exchanges} podem ser: diretas (\english{direct}), em que o valor da chave 
	...
	roteada para a fila; tópicos (\english{topic}), em que é utilizado o casamento de
	...
	e \english{fanout}, em que o roteamento acontece para todas as filas 
...
\begin{itemize}
	...
	para a camada de modelo e, quando um resultado é devolvido para um comando, o
...
uma instância de \lstinline{com.rabbitmq.client.Channel} no qual
podemos executar os comandos definidos na camada de sessão (listagem \ref{lst:channels}). 
Por exemplo a criação de filas (\lstinline{queueDeclare}) ou o envio (\lstinline{basicPublish}) e 
recebimento de mensagens (\lstinline{basicConsume}).
