...
\index{AMQP}
	...
	transporte. Os detalhes dessa camada não se enquadram no escopo 
	deste trabalho. Por fim, apresentamos na seção \ref{sec:amqp-implementacoes} 
	algumas das implementações disponíveis do padrão e qual implementação escolhemos 
...
\section{A camada de sessão}		
	...
	\begin{itemize}
		...
		\item Reenvio e recuperação no caso de falhas de rede: Para que o sistema possa
...
\end{lstlisting}
	...
	uma instância de \lstinline$com.rabbitmq.client.Channel$ por onde
...
\end{lstlisting}
	...
	uma fábrica de conexões, uma conexão, um canal e um consumidor se relacionam. 
	...
	seria lançada e o canal utilizado para executar o comando de criação seria fechado. A regra
	também vale para \english{exchanges}. O procedimento correto é remover, seja via código ou
