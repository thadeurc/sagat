...
\section{Implementações}	
	...
	Java, C++, Ruby, Python e C\#.Net. A implementação está disponível sob a licença 
	Apache $2.0$ \cite{apache-lic}. A implementação da biblioteca cliente para Java é 
	...
	A biblioteca para clientes Java \cite{rabbit-api} disponibilizada pelo projeto 
