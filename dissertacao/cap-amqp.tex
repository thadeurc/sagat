...
Tais comandos incluem os comandos para criação de \english{exchanges} (\lstinline{exchangeDeclare}),
...
\lstinline{handleDelivery} (listagem \ref{lst:sample-consumer}). 	
