...
do Akka via reflexão chamada de \lstinline$ReflectiveAccess$. 
A camada de implementação para o transporte de mensagens entre atores remotos é instanciada nessa
classe. A seção para se informar as 
configurações do módulo de atores remotos é mostrada na listagem \ref{lst:akka-conf-vanilla}.
