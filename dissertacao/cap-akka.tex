...
\begin{itemize}
	...
	É o despachador mais simples de todos os despachadores, já que associa uma \english{thread} para 
...
que novos despachadores sejam criados. Por padrão, os despachadores são criados no pacote
\code{akka.dispatch}.
