...
mensagens recebidas, acessar as referências para um ator supervisor ou ainda atores que estejam
sob supervisão.
...
%\subsubsection{Hierarquia de supervisão} - vale a pena?
...
\begin{itemize}	
	...
	recebidas de clientes remotos. Cada \code{RemoteServerModule} é associado a um \english{host} 
...
mesmo comportamento já mostrado na figura \ref{fig:local-actor-message}, já que do ponto de vista do 
...
%% falar da compactação do stream de bytes
