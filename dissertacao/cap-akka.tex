...
por reflexão com base no tipo da classe (\code{SampleActor}). O construtor utilizado
durante a reflexão é o construtor padrão.
...
\begin{itemize}
	...
	superior da fila tenha sido atingido (para o caso em que há um limite informado). 		
...
Quando a computação for completada, o resultado é devolvido a quem fez a invocação do método.
