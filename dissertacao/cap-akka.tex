...
definição do ator e armazenam informação do \english{host} e porta onde foram criadas. 
...
linguagem Erlang descrita na seção \ref{sec:atores-linguagens-erlang}, conhecida como
...
\begin{itemize}
	...
	ou seja, ambos os atores possuem o mesmo valor para \lstinline$self$;
...
Essa referência é acessível via método \lstinline$self.supervisor$. Um ator que supervisiona 
outros atores também pode ser supervisionado por outro ator, como mostrado na figura 
...
usuário da biblioteca. A seriação completa do ator é útil, por exemplo, 
