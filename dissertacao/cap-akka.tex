...
uma instância de \lstinline{akka.actor.ActorRef}. A instância do ator criado
...
o envio assícrono da mensagem \lstinline{"hello"} ao ator referenciado por \lstinline{theActor}.
...
\begin{itemize}
	...
	É definido na classe \lstinline{ExecutorBasedEventDrivenWorkStealingDispatcher},
...
Além do método \lstinline{!}, que faz o envio assícrono de uma mensagem sem devolver resposta
...
ao remetente, a chamada \lstinline{self.reply} é obrigatória. A listagem \ref{lst:method!!}
