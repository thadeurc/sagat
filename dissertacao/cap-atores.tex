%% ------------------------------------------------------------------------- %%
\chapter{O Modelo de Atores}
\label{cap:atores}

O modelo de atores foi apresentado como um modelo de concorrência em sistemas
distribuídos por Gul Agha \cite{Agha86}.
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.40\textwidth]{escalograma} 
...
\begin{center}
    \begin{tabular}{|c|c|l|}
	 \hline
	 Código & Abreviatura & Nome completo \\ \hline \hline
     \texttt{A} & Ala & Alanina \\
