...
linguagens baseadas no modelo de atores e algumas bibliotecas para linguagens gerais.
...
A criação da linguagem teve como motivação permitir que sistemas que fossem modelados como 
...
que por sua vez pode ser, com a biblioteca de atores SALSA, compilado para \english{bytecode}
...
\begin{enumerate}
	...
	\lstinline$gerente2$. Apesar de \lstinline$diretor$ também receber como argumento
...
\lstinline$receive$ declarado dentro do método \lstinline$act$. No método \lstinline$receive$ são 
definidos os padrões a serem casados com as mensagens que o ator processa e as ações associadas. 
