...
\code{behavior} é semelhante à construção \code{class} de Java, e é utilizada para definir
...
podem implementar zero ou múltiplas \english{interfaces}. 
...
como ator base que estende \code{java.lang.Thread}, de modo que 
...
\code{receive}) é diferente do comportamento dos atores de Erlang e Scala, em que o ator é suspenso. No caso 
