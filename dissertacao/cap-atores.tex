...
\english{behaviors} o estendem direta ou indiretamente. A primitiva \code{<-} é utilizada
para enviar uma mensagem a um ator.

A implementação de atores da linguagem utiliza o objeto \code{salsa.language.Actor}
como ator base que estende \code{java.lang.Thread}, criando uma relação onde 
