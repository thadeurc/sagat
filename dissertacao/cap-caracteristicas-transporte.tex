...
para envio de mensagens para todas as filas criadas para a ponte servidora de nome \lstinline{node1}. 
...
Contudo, a recomendação é que não haja imposição de limites arbitrários, que não sejam motivados por 
