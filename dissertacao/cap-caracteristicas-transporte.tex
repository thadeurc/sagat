...
\begin{itemize}
	...
	define métodos para a criação de instâncias das sub-classes de \code{AMQPBridge};
	...
	\item \code{ServerAMQPBridge}: É uma das duas sub-classes de \code{AMQPBridge} e
	...
	\item \code{ClientAMQPBridge}: É a outra sub-classe de \code{AMQPBridge} e
...
da interação com o \english{message broker}. Como mostrado na sub-seção \ref{subsec:amqp-rabbit-api}, o envio
...
\begin{itemize}
	...
	de mensagens. Essa implementação extende a classe \code{DefaultConsumer}
	...
	\item \code{AMQPConnectionFactory}: É a classe raíz da hierarquia
