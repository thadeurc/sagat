...
canais ou conexões, os atores supervisores possam criar novos atores supervisonados no mesmo estado que 
...
\subsection{Adaptação e experimentos para um ambiente de computação em nuvem}
