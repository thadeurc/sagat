...
Para que pudessemos ter medidas mais reais, separamos os atores clientes e os atores do
...
\begin{itemize}
	...
	nossa implementação não fica atrelhada a esse detalhe. Os endereços IPs dos nós não possuem relação 
...
\subsection{Experimenos em um ambiente de computação em nuvem}
