...
(apêncide x). Naturalmente, pelo fato de as mensagens serem trafegadas duas vezes a mais na rede, a latência
...
Tal vantagem deve-se ao fato de que o JBoss Netty também possui tarefas semelhantes, como recebimento e entrega
...
Nas seções \ref{sec:entidades-ponto-a-ponto} e \ref{sec:entidades-via-broker-amqp}, mencionamos algumas
características.
%% falar sobre detalhes de infra.. numero de portas, etc
%% mensagens persistidas
%% saber de erros remotos



Nossa conclusão final é de que existe sim uma sinergia entre as duas classes de sistemas de 
\english{software} baseadas em troca de mensagens estudadas neste trabalho.
